...
reserved_non_modifiers:
	...
	| T_CLASS_C | T_TRAIT_C | T_FUNC_C | T_METHOD_C | T_LINE | T_FILE | T_DIR | T_NS_C | T_ASYNC | T_AWAIT
;
...
expr:
	...
	|	T_ASYNC expr { $$ = zend_ast_create(ZEND_AST_ASYNC, $2, NULL); }
	|	T_ASYNC expr T_DOUBLE_ARROW expr { $$ = zend_ast_create(ZEND_AST_ASYNC, $4, $2); }
	|	T_AWAIT expr { $$ = zend_ast_create(ZEND_AST_AWAIT, $2); }
